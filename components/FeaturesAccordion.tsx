...
const features = [
  ...
  },
  {
    title: "Data Privacy",
    description:
      "You entries are not stored in any database, its automatically deleted after reading the content.",
    type: "image",
  ...
  },
  {
    title: "Coming Soon",
    description:
      "We are working on new features to help you stay lazy. Stay tuned!",
    svg: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
...
const FeaturesAccordion = () => {
  ...
  return (
    <section
      className="py-24 md:py-32 space-y-24 md:space-y-32 max-w-7xl mx-auto bg-[#121212] "
      id="features"
    >
      <div className="px-8">
        <h2 className="font-extrabold text-4xl lg:text-6xl text-red mb-12 md:mb-24">
          This is all you need to accelerate your {" "}
